...
| `]` / `[` | Jump to next/prev agent waiting for input (Prompting or bell; **fleet-wide** — crosses workspaces, switching the focused tab; wraps) |
