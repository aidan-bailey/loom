...
var (
	...
	BorderMuted = compat.AdaptiveColor{Light: lipgloss.Color("#999999"), Dark: lipgloss.Color("#555555")}

	// TextDim is for secondary labels, hints, and idle text elements.
	TextDim = compat.AdaptiveColor{Light: lipgloss.Color("#999999"), Dark: lipgloss.Color("#666666")}
